...
############################################################### 
	...
	$settings = array(
		'consumer_key' => "v7pNFVWWumMituyiv1yuCduR8",
		'consumer_secret' => "nNI26GUZnZslKjF2Ogh8kCNn3HDzKEtC0sz79nWPzwGvAvVwHu",
		'oauth_access_token' => "128749092-usxNocUXsDEdoQsMmUr6QcwKCtN6Co23CQuMUfik",
		'oauth_access_token_secret' => "tHQvM3pUbHbvNxwJU41yOuBEz7ZM19EKHFh5JTxjEYlDE"
	);
	
	// Set API request URL and timeline variables if needed <https://dev.twitter.com/docs/api/1.1>
	$url = 'https://api.twitter.com/1.1/statuses/user_timeline.json';
	$twitterUsername = "comerydivertirse";
	$tweetCount = 3;
	
	// Use private tokens for development if they exist; delete when no longer necessary
	$tokens = '/inc/twitter/tokens.php';
